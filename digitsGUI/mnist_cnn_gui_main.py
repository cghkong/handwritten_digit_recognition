...
from digitsrecognitionAPP.qt.layout import Ui_Dialog
from digitsrecognitionAPP.qt.paintboard import PaintBoard

from PyQt5.QtWidgets import QMainWindow, QDesktopWidget, QApplication,QDialog
